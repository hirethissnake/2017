...
helath, and providing Main with the best next move."""
...
class Game:
    ...
    def __init__(self, size):
        ...
        #TODO
            # Init weight grid, init grid graph ** not 100% sure about \
            #  relationship here, maybe graph should have grid as a child to
            #  make pathing decisions **
            # Init snakes
